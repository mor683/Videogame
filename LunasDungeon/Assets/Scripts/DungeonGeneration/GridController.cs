...
public class GridController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        grid.columns = room.Width - 6;  // para evitar spawnear enemigos en los bordes de la sala
        grid.rows = room.Height - 6;    // para evitar spawnear enemigos en los bordes de la sala
        GenerateGrid();
